...
contract VyperDeployer {
    ...
    function deployContract(string memory fileName) public returns (address) {
        ...
        cmds[0] = "vyper";
        cmds[1] = string.concat("contracts/curve/", fileName, ".vy");
        ...
        require(deployedAddress.code.length > 0, "VyperDeployer could not deploy contract");
    ...
    function deployContract(string memory fileName, bytes calldata args) public returns (address) {
        ...
        string[] memory cmds = new string[](2);
        cmds[0] = "vyper";
        cmds[1] = string.concat("contracts/", fileName, ".vy");
